       ...
       bg-neutral-300 before:pointer-events-none before:absolute before:h-3.5 before:w-3.5
        ...
        checked:after:content-[''] hover:cursor-pointer
         ...
         focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1]
          focus:after:block focus:after:h-5 focus:after:w-5 focus:after:rounded-full 
          focus:after:content-[''] checked:focus:border-primary checked:focus:bg-primary
           ...
           checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s]
            ...
            dark:checked:after:bg-blue-500 
